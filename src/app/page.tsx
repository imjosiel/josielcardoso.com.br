...
export default function Home() {
  return (
    <div>
      <div className="flex min-h-screen flex-col items-center justify-between pt-24">
        ...
        <div className="flex display-between gap-x-[256px]">
          <h2 className="w-[360px] h-[74px] font-semibold text-lg mt-16">
            Desenvolvedor fullstack com especialização em backend e experiência
            no desenvolvimento de APIs e segurança de sistemas. Possui
            habilidades em tecnologias como Spring Boot, Node.js e MuleSoft,
            além de bancos de dados como MySQL e MongoDB. Embora o foco
            principal esteja no backend, também tem conhecimentos avançados e
            experiência comprovada com em frontend com React.js e Next.js,
            permitindo uma atuação integrada em projetos. Alguns projetos
            fullstack desenvolvidos podem ser vistos abaixo.
          </h2>
      ...
      <div
        id="about"
        className="z-10 w-full min-h-screen max-w-5xl items-center justify-between font-mono text-sm lg:flex mt-16 p-4 mx-auto"
      >
        <div className="flex gap-x-[256px]">
          ...
          <h2 className="w-[820px] h-[74px] font-semibold text-lg mt-0">
